    ...
    <div class="container">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:4rem; align-items:center;">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #2a2520 0%, #1a1510 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🤵</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Charcoal Classic</div><p class="card__text" style="font-size:0.8rem;">Timeless single-breasted, slim fit</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #0d1a2e 0%, #071020 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🌊</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Navy Shadow</div><p class="card__text" style="font-size:0.8rem;">Deep navy, modern cut</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #3a3020 0%, #2a2015 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🎩</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Dark Caramel</div><p class="card__text" style="font-size:0.8rem;">Warm brown, double-breasted</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #888 0%, #666 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🩶</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Mid Grey</div><p class="card__text" style="font-size:0.8rem;">Versatile grey, regular fit</p></div></div>
            </div>
        </div>
    </div>
</section>
...
<section class="section section--light" id="tuxedos">
    <div class="container">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:4rem; align-items:center;">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🖤</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Midnight Black</div><p class="card__text" style="font-size:0.8rem;">Classic satin lapel, slim cut</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #f5f5f5 0%, #e0e0e0 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🤍</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Ivory White</div><p class="card__text" style="font-size:0.8rem;">Wedding & summer events</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #1a2a1a 0%, #0d1a0d 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🌿</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Hunter Green</div><p class="card__text" style="font-size:0.8rem;">Bold & contemporary</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #4a0a4a 0%, #2d052d 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">💜</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Deep Burgundy</div><p class="card__text" style="font-size:0.8rem;">Rich colour, peak lapel</p></div></div>
            </div>
            <div>
...
<section class="section" id="kids">
    <div class="container">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:4rem; align-items:center;">
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #0d1a2e 0%, #071020 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🧒</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Boys' Navy</div><p class="card__text" style="font-size:0.8rem;">Classic navy, all ages</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #2a2520 0%, #1a1510 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">👦</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Boys' Charcoal</div><p class="card__text" style="font-size:0.8rem;">Sharp & timeless</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #c8b89a 0%, #a89070 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🌾</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Champagne Linen</div><p class="card__text" style="font-size:0.8rem;">Summer & outdoor events</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🎩</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Mini Tuxedo</div><p class="card__text" style="font-size:0.8rem;">Black-tie for little ones</p></div></div>
            </div>
        </div>
    </div>
</section>
...
<section class="section section--light" id="prom">
    <div class="container">
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:4rem; align-items:center;">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #4a0a4a 0%, #2d052d 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🎆</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Prom Royale</div><p class="card__text" style="font-size:0.8rem;">Burgundy, black & gold</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #1a2a1a 0%, #0d1a0d 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">✨</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Emerald Night</div><p class="card__text" style="font-size:0.8rem;">Hunter green, peak lapel</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #152540 0%, #0a1828 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">💫</div><div class="card__body"><div class="card__title" style="font-size:1rem;">Royal Blue</div><p class="card__text" style="font-size:0.8rem;">Vibrant & modern</p></div></div>
                <div class="card"><div style="height:200px; background: linear-gradient(135deg, #f5f5f5 0%, #e0e0e0 100%); display:flex; align-items:center; justify-content:center; font-size:3rem;">🌟</div><div class="card__body"><div class="card__title" style="font-size:1rem;">All-White</div><p class="card__text" style="font-size:0.8rem;">Statement prom look</p></div></div>
            </div>
            <div>
